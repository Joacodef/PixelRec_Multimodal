...
def main():
    ...
    try:
        ...
        splits_dir = Path(data_config.processed_interactions_path)
        
        train_interactions_df = pd.read_csv(splits_dir / "train.csv")
        val_interactions_df = pd.read_csv(splits_dir / "val.csv")
